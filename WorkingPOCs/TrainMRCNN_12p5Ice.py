...
dataset_path=os.path.join(ROOT_DIR,'IceData','NRC_12_5mIce')
model_path = os.path.join(ROOT_DIR,'Dec12_NRC_12_5mIce.h5') #path where you want model saved
...
if __name__ == '__main__':
    ...
    print("Logan check here")
    print(tf.config.experimental.list_physical_devices())
    print(tf.test.is_gpu_available())
    print(tf.test.gpu_device_name(),"\n\n")
    print("Logan end check here")
